...
export default {
  ...
  computed: {
    ...
    filterRatings() {
      ...
      if (selectType === 2 && onlyShowText === false) {
        console.log(1);
        return ratings;
      } else if (selectType === 2 && onlyShowText === true) {
      ...
      else if(onlyShowText === false){
        return ratings.filter((rating) => {
          console.log(3);
          const { rateType } = rating;
          return rateType === selectType;
        });
      }
      else {
        return ratings.filter((rating) => {
          ...
          return rateType === selectType && text.length > 0;
        });
      }
    },
  },
  ...
  methods: {
    setSelectType(numType) {
      this.selectType = numType;
    },
    toggleOnlyShowText() {
